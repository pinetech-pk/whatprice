...
export default function InvestmentsPage() {
  ...
  return (
    <div className="p-6 lg:p-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Investor Submissions</h1>
        <p className="text-gray-500 mt-1">Manage investor interest form submissions</p>
      </div>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {submission.company || <span className="text-gray-400">-</span>}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
        ...
        >
          ...
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="text-sm font-medium text-gray-500">Investment Interest</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{selectedSubmission.ipAddress || 'Unknown'}</p>
                </div>
              </div>
            </div>
